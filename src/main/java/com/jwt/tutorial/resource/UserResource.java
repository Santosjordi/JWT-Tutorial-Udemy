...
import static com.jwt.tutorial.constant.FileConstant.*;
...
public class UserResource {
    ...
    public ResponseEntity<User> updateProfileImage(@RequestParam("username") String username,
        ...
        User userWithNewImage = userService.updateProfileImage(username, profileImage);
        return new ResponseEntity<>(userWithNewImage, OK);
    }
